...
from src.datascience.pipeline.data_ingestion_pipeline import DataIngestionTrainingPipeline, STAGE_NAME
from src.datascience.pipeline.data_validation_pipeline import DataValidationTrainingPipeline
from src.datascience.pipeline.data_transformation_pipeline import DateTransformationTrainingPipeline
...
try:
    logger.info(f">>>>>> stage {STAGE_NAME} started <<<<<<")
    data_ingestion = DateTransformationTrainingPipeline()
